        ...
        <div className="mt-8 grid gap-4">
          ...
          <section className="premium-panel rounded-[1.5rem] p-6 sm:p-7">
            <div className="relative z-10">
              ...
              <p className="mt-3 text-sm leading-7 text-muted">For privacy questions or service-request updates, contact Planetlocksmiths by phone at <span className="notranslate" translate="no">{global.phoneDisplay}</span> or use the request form on the contact page.</p>
            </div>
          </section>
        </div>
      </main>
