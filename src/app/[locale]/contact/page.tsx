...
const fallbackCopy: Record<ActiveLocale, { eyebrow: string; title: string; intro: string; phone: string; serviceType: string; serviceValue: string; area: string; areaValue: string; sideTitle: string; sideText: string; call: string; request: string }> = {
  en: { eyebrow: 'Contact Planetlocksmiths', title: 'Request mobile locksmith service', intro: 'Use the form below to send service details, location, urgency, and contact information. For urgent lockouts, lost keys, business access problems, or safe issues, calling may be faster.', phone: 'Phone', serviceType: 'Service type', serviceValue: 'Mobile locksmith service', area: 'Common area', areaValue: 'Philadelphia, Pennsylvania and nearby coverage areas', sideTitle: 'What makes the request faster', sideText: 'Service type, exact location, phone number, urgency, access authorization, and vehicle details when relevant help create a cleaner callback path.', call: 'Call', request: 'Request service' },
  es: { eyebrow: 'Contacto Planetlocksmiths', title: 'Solicitar servicio móvil de cerrajería', intro: 'Use el formulario para enviar servicio, ubicación, urgencia y contacto. Para bloqueos urgentes, llaves perdidas, acceso comercial o cajas fuertes, llamar puede ser más rápido.', phone: 'Teléfono', serviceType: 'Tipo de servicio', serviceValue: 'Cerrajería móvil', area: 'Área común', areaValue: 'Philadelphia, Pennsylvania y áreas cercanas', sideTitle: 'Qué acelera la solicitud', sideText: 'Tipo de servicio, ubicación exacta, teléfono, urgencia, autorización y datos del vehículo cuando aplique ayudan a una respuesta más clara.', call: 'Llamar', request: 'Solicitar servicio' },
}
