        ...
        <div className="mt-8 grid gap-4">
          ...
          <section className="premium-panel rounded-[1.5rem] p-6 sm:p-7">
            <div className="relative z-10">
              ...
              <p className="mt-3 text-sm leading-7 text-muted">For questions about a request or these terms, contact <span className="notranslate" translate="no">{global.brandName}</span> by phone at <span className="notranslate" translate="no">{global.phoneDisplay}</span>.</p>
            </div>
          </section>
        </div>
      </main>
