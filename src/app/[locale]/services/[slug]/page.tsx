  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8 text-text">
        {service ? (
          <>
            <h1 className="mb-6 text-3xl font-heading font-semibold">{service.title}</h1>
            <p className="mb-4">{service.excerpt}</p>
            <p>
              This is a placeholder page for the {service.title} service. In the future you can add more
