...
const fallbackCopy: Record<ActiveLocale, { eyebrow: string; title: string; intro: string; call: string; request: string; cardPrefix: string; open: string; empty: string; sideTitle: string; sideText: string; countLabel: string; ctaTitle: string; ctaText: string }> = {
  en: {
    ...
    intro: 'Mobile locksmith service for car lockouts, all keys lost, key programming, rekeys, lock repair, lock replacement, residential, commercial, access control, safe opening, and emergency calls.',
    call: 'Call',
    request: 'Request service',
    cardPrefix: 'Service',
    open: 'Open page',
    empty: 'Call for the current service list.',
    sideTitle: 'Service ready',
    sideText: 'Choose the service you need, then call or send the service type, location, phone number, urgency, and vehicle details when relevant.',
    countLabel: 'Available services',
    ctaTitle: 'Need locksmith help now?',
    ctaText: 'Call Planet Locksmiths or send the lock, key, door, safe, mailbox, access-control, or vehicle details that apply.',
  },
  es: {
    ...
    cardPrefix: 'Servicio',
    open: 'Abrir página',
    empty: 'Llama para confirmar la lista actual de servicios.',
    sideTitle: 'Servicio listo',
    sideText: 'Elija el servicio que necesita y luego llame o envíe tipo de servicio, ubicación, teléfono, urgencia y datos del vehículo cuando aplique.',
    countLabel: 'Servicios disponibles',
    ctaTitle: '¿Necesitas ayuda de cerrajería?',
    ctaText: 'Llama a Planet Locksmiths o envía detalles de cerradura, llave, puerta, caja fuerte, buzón, access control o vehículo.',
  },
}
