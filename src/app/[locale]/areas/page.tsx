...
const fallbackCopy: Record<ActiveLocale, { eyebrow: string; title: string; intro: string; call: string; request: string; cardPrefix: string; open: string; empty: string; sideTitle: string; sideText: string; countLabel: string }> = {
  en: { eyebrow: 'Planet Locksmiths / coverage', title: 'Service Areas', intro: 'Mobile locksmith service for Philadelphia and nearby coverage areas, including emergency, automotive, residential, commercial, safe, and access-control needs.', call: 'Call', request: 'Request service', cardPrefix: 'Area', open: 'Open area', empty: 'Call to confirm current service coverage.', sideTitle: 'Coverage ready', sideText: 'Service timing depends on technician availability, location, distance, service type, parts, timing, authorization, and job complexity.', countLabel: 'Coverage areas' },
  es: { eyebrow: 'Planet Locksmiths / cobertura', title: 'Áreas de servicio', intro: 'Servicio móvil de cerrajería para Philadelphia y áreas cercanas: emergencia, auto, residencial, comercial, cajas fuertes y access control.', call: 'Llamar', request: 'Solicitar servicio', cardPrefix: 'Área', open: 'Abrir área', empty: 'Llama para confirmar la cobertura actual.', sideTitle: 'Cobertura lista', sideText: 'El tiempo de servicio depende de disponibilidad, ubicación, distancia, tipo de servicio, piezas, horario, autorización y complejidad.', countLabel: 'Áreas de cobertura' },
}
