...
const fallbackCopy: Record<ActiveLocale, { eyebrow: string; title: string; intro: string; call: string; request: string; cardPrefix: string; open: string; empty: string; sideTitle: string; sideText: string; countLabel: string }> = {
  en: { eyebrow: 'Planet Locksmiths / coverage', title: 'Service Areas', intro: 'Mobile locksmith coverage pages help customers understand where service may be available, what support is offered, and what details are needed before requesting help.', call: 'Call', request: 'Request service', cardPrefix: 'Area', open: 'Open area', empty: 'No published areas yet.', sideTitle: 'Coverage ready', sideText: 'Coverage depends on technician availability, location, distance, service type, parts, timing, authorization, and job complexity.', countLabel: 'Published areas' },
  es: { eyebrow: 'Planet Locksmiths / cobertura', title: 'Áreas de servicio', intro: 'Las páginas de cobertura móvil ayudan a los clientes a entender dónde puede estar disponible el servicio, qué soporte se ofrece y qué datos se necesitan antes de solicitar ayuda.', call: 'Llamar', request: 'Solicitar servicio', cardPrefix: 'Área', open: 'Abrir área', empty: 'No hay áreas publicadas todavía.', sideTitle: 'Cobertura lista', sideText: 'La cobertura depende de disponibilidad, ubicación, distancia, tipo de servicio, piezas, horario, autorización y complejidad.', countLabel: 'Áreas publicadas' },
}
