...
export default function AdminFaqPage() {
  ...
  return (
    <div>
      <HeaderBlock
        breadcrumb="Planetlocksmiths / Admin / FAQ"
        title="FAQ"
      ...
      <AdminStickySaveBar
        formId={FORM_ID}
        isSaving={isSaving}
        label={`Save ${activeLocale.toUpperCase()} FAQ`}
        note={`FAQ changes for ${activeLocale.toUpperCase()} stay ready at the bottom while you scroll.`}
      />
    </div>
  )
}
