...
const uploadButtonStyle: CSSProperties = { minHeight: 46, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: '0 18px', borderRadius: 999, border: '1px solid rgba(214,168,95,0.42)', background: 'rgba(214,168,95,0.12)', color: '#D6A85F', fontWeight: 900, textTransform: 'uppercase', letterSpacing: 1.2, cursor: 'pointer' }
