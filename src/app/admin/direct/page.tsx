...
const links = [
  ...
  { title: 'Content Blocks', href: '/admin/content-blocks-v3', description: 'Modular editor with shared presets, previews, reusable blocks, CTA copy, and section items.', accent: '#2DE2E6' },
...
function getQualityItems(metrics: Metrics): QualityItem[] {
  return [
    { title: 'Content blocks', href: '/admin/content-blocks-v3', status: 'warn', note: 'Use the modular editor for shared presets, previews, and reusable page modules.' },
