      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          {areas.map((area, index) => {
            ...
            return (
              <PremiumReveal key={area.slug} delay={Math.min(index * 0.045, 0.18)}>
                <Link href={`/${locale}/areas/${area.slug}`} className="group premium-panel relative block min-h-[15rem] overflow-hidden rounded-[1.5rem] p-5 transition duration-500 hover:-translate-y-1.5 hover:border-accent-blue/40 hover:shadow-[0_0_64px_rgba(77,162,255,0.10)]">
