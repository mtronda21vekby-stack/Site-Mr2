export default function CinematicBackground() {
  return (
    <div aria-hidden="true" className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-[#02040A]">
      ...
      <div className="unlock-scene absolute left-1/2 top-[-7rem] h-[42rem] w-[42rem] -translate-x-1/2 opacity-80 sm:top-[-9rem] md:left-[67%] md:top-[-8rem] md:h-[50rem] md:w-[50rem] md:opacity-95">
        <div className="unlock-core absolute inset-[10%] rounded-full border border-white/10 bg-[radial-gradient(circle_at_42%_34%,rgba(255,255,255,0.08),transparent_18%),radial-gradient(circle_at_52%_52%,#101827_0%,#060B13_48%,#02040A_72%)] shadow-[inset_0_1px_0_rgba(255,255,255,0.18),inset_0_-40px_90px_rgba(0,0,0,0.72),0_0_110px_rgba(77,162,255,0.14)]" />
        <div className="unlock-ring unlock-ring-a absolute inset-[7%] rounded-full border border-accent-blue/18" />
        <div className="unlock-ring unlock-ring-b absolute inset-[15%] rounded-full border border-accent-gold/18" />
        <div className="unlock-ring unlock-ring-c absolute inset-[23%] rounded-full border border-white/10" />
        ...
        <div className="unlock-key absolute left-1/2 top-[2.5rem] h-44 w-16 -translate-x-1/2 rounded-full">
