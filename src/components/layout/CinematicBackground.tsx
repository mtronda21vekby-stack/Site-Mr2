import UnlockCityCoreScene from '@/components/background/UnlockCityCoreScene'
...
export default function CinematicBackground() {
  return (
    <div aria-hidden="true" className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-[#02040A]">
      ...
      <div className="absolute inset-0 opacity-[0.025] mix-blend-screen [background-image:radial-gradient(circle_at_center,rgba(255,255,255,0.7)_0.55px,transparent_0.8px)] [background-size:4px_4px]" />
    </div>
  )
}
