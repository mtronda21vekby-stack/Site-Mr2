...
const footerLabels: Record<Locale, { home: string; services: string; areas: string; contact: string; privacy: string; terms: string; cookiePreferences: string; request: string; rights: string; description: string; serviceNote: string; disclaimer: string; serviceTypes: string; customerInfo: string; defaultServiceItems: string[] }> = {
  en: { home: 'Home', services: 'Services', areas: 'Service Areas', contact: 'Contact', privacy: 'Privacy Policy', terms: 'Terms of Service', cookiePreferences: 'Cookie preferences', request: 'Request Service', rights: 'All rights reserved.', description: 'Planet Locksmiths provides 24/7 mobile locksmith service for car lockouts, key programming, rekeys, lock repair, lock replacement, residential, commercial, access control, safe opening, and emergency locksmith needs.', serviceNote: 'Call for urgent lockouts or send the service details, location, and contact information for scheduling.', disclaimer: 'Service timing, authorization, parts, and final pricing are confirmed before work begins.', serviceTypes: 'Locksmith services', customerInfo: 'Customer information', defaultServiceItems: ['Emergency locksmith 24/7', 'Car lockout service', 'Rekey service', 'Commercial locksmith', 'Residential locksmith'] },
  es: { home: 'Inicio', services: 'Servicios', areas: 'Áreas', contact: 'Contacto', privacy: 'Política de privacidad', terms: 'Términos de servicio', cookiePreferences: 'Preferencias de cookies', request: 'Solicitud', rights: 'Todos los derechos reservados.', description: 'Planet Locksmiths ofrece cerrajería móvil 24/7 para bloqueos, programación de llaves, rekeys, reparación, reemplazo, residencial, comercial, access control, cajas fuertes y emergencias.', serviceNote: 'Llama para urgencias o envía servicio, ubicación y datos de contacto para coordinar.', disclaimer: 'Tiempo de servicio, autorización, piezas y precio final se confirman antes de comenzar.', serviceTypes: 'Servicios de cerrajería', customerInfo: 'Información al cliente', defaultServiceItems: ['Cerrajero de emergencia 24/7', 'Bloqueo de automóvil', 'Rekey', 'Cerrajero comercial', 'Cerrajero residencial'] },
