...
function localeButtonStyle(active: boolean): CSSProperties { return { minHeight: 44, padding: '0 15px', borderRadius: 999, border: active ? '1px solid rgba(214,168,95,0.42)' : '1px solid rgba(255,255,255,0.12)', background: active ? 'rgba(214,168,95,0.12)' : 'rgba(255,255,255,0.035)', color: active ? '#D6A85F' : '#F5F7FB', fontWeight: 900 } }
...
const primaryButtonStyle: CSSProperties = { minHeight: 48, padding: '0 16px', borderRadius: 999, border: '1px solid rgba(214,168,95,0.42)', background: '#F5F7FB', color: '#02040A', fontWeight: 900, textTransform: 'uppercase', letterSpacing: 1.1 }
...
const presetPanelStyle: CSSProperties = { borderRadius: 24, border: '1px solid rgba(214,168,95,0.22)', background: 'linear-gradient(145deg, rgba(17,25,46,0.82), rgba(5,7,11,0.72))', padding: 18, display: 'grid', gap: 14 }
...
const previewMetaStyle: CSSProperties = { margin: '10px 0 0', color: '#F0D099', fontSize: 13 }
...
const previewKickerStyle: CSSProperties = { margin: 0, color: '#F5F7FB', fontSize: 11, fontWeight: 900, textTransform: 'uppercase', letterSpacing: 1.8 }
const listStyle: CSSProperties = { margin: '10px 0 0', paddingLeft: 18, color: '#95A0B8', lineHeight: 1.55 }
const previewCtaStyle: CSSProperties = { margin: '10px 0 0', color: '#F5F7FB', fontWeight: 900 }
...
const readyPillStyle: CSSProperties = { ...summaryPillStyle, border: '1px solid rgba(214,168,95,0.24)', background: 'rgba(214,168,95,0.08)', color: '#D6A85F' }
