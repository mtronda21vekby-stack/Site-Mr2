...
export default function CinematicVideoBackground() {
  ...
  return (
    <div aria-hidden="true" className="pointer-events-none fixed inset-0 -z-20 overflow-hidden bg-[#02040A]">
      <video
        ref={videoRef}
        className="absolute left-1/2 top-1/2 h-full w-full min-h-full min-w-full -translate-x-1/2 -translate-y-1/2 object-cover opacity-78 saturate-[1.12] contrast-[1.12] brightness-[0.70] object-center scale-[1.06] md:scale-[1.06] max-md:object-[46%_50%] max-md:scale-100 max-md:opacity-96 max-md:saturate-[1.12] max-md:contrast-[1.08] max-md:brightness-[0.9]"
        muted
        playsInline
        preload="metadata"
        src={activeVideoSrc}
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_64%_32%,rgba(0,0,0,0.04)_0%,rgba(0,0,0,0.30)_42%,rgba(0,0,0,0.90)_100%)] max-md:bg-[radial-gradient(circle_at_46%_28%,rgba(0,0,0,0.00)_0%,rgba(0,0,0,0.08)_48%,rgba(0,0,0,0.66)_100%)]" />
